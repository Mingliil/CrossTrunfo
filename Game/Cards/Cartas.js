...
DeckFull.TVTIME = {
    nome:"ANT. TENNA",
    raridade:"ÉPICO",
    descricao:"<B>COMING STRAIGHT FROM YOUR HOUSE <BR>COMING STRAIGHT FROM YOUR HOUSE <BR>COMING— <BR>HE'S THE ONE <BR>COMING— <BR>THE KING OF ONLY <BR>HE'S GROOVY AND NEVER GLOOBY <BR>YOU CAN'T GET THIS FROM AN EGG <BR>THE SENSATION OF YOUR SCREEN <BR>THE SHOW THAT MAKES YOU SCREAM <BR>SAY IT WITH HIM, FOLKS <BR>MR. 'ANT' TENNA'S TV TIME",
    Atlas:'Assets/cards.png',
    Audiofont:"Assets/audios/Intros/tvtime.mp3",
